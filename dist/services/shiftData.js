...
function generateShiftData(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const actualH = `${Math.abs(Math.abs(data.endT.hour - data.startT.hour))}:${Math.abs(60 - data.startT.min) + data.endT.min}`;
            const timeSheetData = yield Shift_1.default.create({
                id: (0, uuid_1.v4)(),
